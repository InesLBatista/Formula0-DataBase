    ...
    public partial class TeamDetailsForm : Form
    {
        ...
        private void LoadTeamDetails()
        {
            ...
            try
            {
                ...
                {
                    string query = "SELECT * FROM vw_Team_Details WHERE ID_Equipa = @TeamId";
        ...
        private void btnSave_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    SqlCommand command = new SqlCommand("sp_UpdateTeamDetails", connection);
                    command.CommandType = CommandType.StoredProcedure;
                    command.Parameters.AddWithValue("@ID_Equipa", teamId);
                    ...
                    command.Parameters.AddWithValue("@Power_Unit", string.IsNullOrWhiteSpace(txtPowerUnit?.Text) ? DBNull.Value : txtPowerUnit.Text);
